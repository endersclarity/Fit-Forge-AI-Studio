...
**And:** User sees celebrationnotification
...
**Description:** System SHALL NOT trigger PR detection (warm-ups, deloads, submaximal work).
...
**Description:** When PR detected, System SHALL display to user a clear, motivating notification.
...
**Description:** System SHALL include in API response PR detection results for frontend notification.
...
*This spec ensures PR detection is accurate, motivating, and respects training context (failure vs non-failure sets).*
