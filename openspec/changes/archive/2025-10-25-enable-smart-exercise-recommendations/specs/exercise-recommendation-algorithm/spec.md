# Spec: Exercise Recommendation Algorithm

**Capability:** `exercise-recommendation-algorithm`
**Status:** Proposed
**Created:** 2025-10-25
...
### Requirement: Calculate Opportunity Scores for Exercises
...
### Requirement: Detect Limiting Factors
...
### Requirement: Filter by Equipment Availability
...
### Requirement: Determine Recommendation Status
...
### Requirement: Sort Recommendations by Opportunity Score
...
### Requirement: Filter by Exercise Category
...
**File Location:** `utils/exerciseRecommendations.ts`
...
export function checkEquipmentAvailable(
...
- types.ts (Muscle, Exercise, MuscleStatesResponse, EquipmentItem)

---

*These requirements define the core recommendation algorithm that powers intelligent exercise suggestions based on real-time muscle readiness data.*
