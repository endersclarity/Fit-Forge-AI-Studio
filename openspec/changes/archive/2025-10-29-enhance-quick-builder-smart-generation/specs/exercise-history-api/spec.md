# Capability: Exercise History API

## Overview

Provide API endpoint to query user's last performance and personal records for any exercise, enabling smart defaults and progressive overload calculations.

**Related Capabilities:**
- `volume-slider-ui` - Consumes this data for pre-population
- `target-driven-workout-generation` - Uses history for workout generation
...
```sql
SELECT we.weight, we.reps, w.completed_at
