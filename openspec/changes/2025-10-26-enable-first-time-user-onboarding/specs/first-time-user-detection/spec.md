# Specification: First-Time User Detection

## Overview

Detect when a user is opening FitForge for the first time (no profile exists) and gracefully handle this scenario by routing to onboarding flow instead of crashing.
